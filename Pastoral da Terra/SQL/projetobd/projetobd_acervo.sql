...
CREATE TABLE `acervo` (
  ...
  `pal_chave` varchar(255) DEFAULT NULL,
...
INSERT INTO `acervo` VALUES (1,'palavra1,palavra2,palavra3','Título 1','2000-01-01','Autor 1'),(2,'palavra4,palavra5,palavra6','Título 2','2005-05-05','Autor 2');
