...
CREATE TABLE `opera` (
  ...
  KEY `CPF` (`CPF`,`ID_func`),
  CONSTRAINT `opera_ibfk_1` FOREIGN KEY (`ID_acervo`) REFERENCES `acervo` (`ID_acervo`),
  CONSTRAINT `opera_ibfk_2` FOREIGN KEY (`CPF`, `ID_func`) REFERENCES `funcionario` (`CPF`, `ID_func`)
...
INSERT INTO `opera` VALUES (1,NULL,1),(2,NULL,1);
